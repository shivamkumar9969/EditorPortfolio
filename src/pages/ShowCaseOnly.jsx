...
export function GitIgnore() {
  return (
    <div className="text-white font-mono text-sm whitespace-pre-wrap">
      <h2 className="text-base font-bold text-gray-500 mb-2">
        <span className="text-gray-500">{`//`}</span> .gitignore
      </h2>
      <code>
...
export function PackageJson() {
  return (
    <div className="text-white font-mono text-sm whitespace-pre-wrap">
      <h2 className="text-base font-bold text-gray-500 mb-2">
        <span className="text-gray-500">{`//`}</span> package.json
      </h2>
      <code>
        {`{
  ...
  "devDependencies": {
    ...
    "postcss": "^8.4.24"
      ...
      <p className="text-xs text-gray-500 mt-4">
        <span className="text-gray-500">{`//`}</span> Showcase only: Represents
        packages used in building this portfolio
      </p>
    </div>
  );
}
...
export function Readme() {
  return (
    <div className="text-white font-mono text-sm whitespace-pre-wrap">
      <h2 className="text-base font-bold text-gray-500 mb-2">
        <span className="text-gray-500">{`//`}</span> README.md
      </h2>
      <code>
